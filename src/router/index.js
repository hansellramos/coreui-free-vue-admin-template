...
const routes = [
  {
    ...
    children: [
      ...
      // Business logic routes
      {
        ...
        children: [
          ...
          },
          {
            ...
            props: true,
            meta: { breadcrumb: 'Detalle de Organización' },
          },
          {
            ...
            component: () => import('@/views/organizations/OrganizationDetail.vue'),
            props: true,
            meta: { breadcrumb: 'Ver Organización' },
          },
          {
            ...
            component: () => import('@/views/organizations/OrganizationFormView.vue'),
            props: true,
            meta: { breadcrumb: 'Editar Organización' },
          },
          {
            path: 'venues',
            name: 'Venues',
            component: () => import('@/views/venues/VenuesList.vue'),
            meta: { breadcrumb: 'Reporte de Cabañas' },
          },
          {
            path: 'venues/create',
            name: 'VenueCreate',
            component: () => import('@/views/venues/VenueFormView.vue'),
            meta: { breadcrumb: 'Crear Cabaña' },
          },
          {
            path: 'venues/:id',
            name: 'VenueDetail',
            ...
            props: true,
            meta: { breadcrumb: 'Detalle de Cabaña' },
          },
          {
            path: 'venues/:id/read',
            name: 'VenueRead',
          ...
          },
          {
            ...
            props: true,
            meta: { breadcrumb: 'Detalle de Contacto' },
          },
          {
          ...
          },
          {
            ...
            component: () => import('@/views/contacts/ContactFormView.vue'),
            props: true,
            meta: { breadcrumb: 'Editar Contacto' },
          },
        ],
      },
      ...
      },
      {
        ...
        meta: { breadcrumb: 'Reporte de Cotizaciones' },
      },
      {
        path: '/business/estimates/create',
        name: 'EstimateCreate',
        component: () => import('@/views/estimates/EstimateFormView.vue'),
        meta: { breadcrumb: 'Crear Cotización' },
      },
      {
        path: '/business/estimates/:id',
        name: 'EstimateDetail',
        component: () => import('@/views/estimates/EstimateDetailView.vue'),
        props: true,
        meta: { breadcrumb: 'Detalle de Cotización' },
      },
      {
        path: '/business/estimates/:id/edit',
        name: 'EstimateEdit',
        component: () => import('@/views/estimates/EstimateFormView.vue'),
        props: true,
        meta: { breadcrumb: 'Editar Cotización' },
      },
    ],
  },
  {
