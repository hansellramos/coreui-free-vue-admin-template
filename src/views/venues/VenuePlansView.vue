            ...
            <CRow class="mb-3">
              <CCol :md="6">
                ...
                <div v-if="showCheckInOptions" class="d-flex gap-2 flex-wrap mt-2">
                  <CButton v-for="t in checkInTimeOptions" :key="t" size="sm" color="secondary" variant="outline" @mousedown.prevent @touchstart.prevent @click.stop="selectCheckInTime(t)">{{ t }}</CButton>
                </div>
              </CCol>
              <CCol :md="6">
                ...
                <div v-if="showCheckOutOptions" class="d-flex gap-2 flex-wrap mt-2">
                  <CButton v-for="t in checkOutTimeOptions" :key="t" size="sm" color="secondary" variant="outline" @mousedown.prevent @touchstart.prevent @click.stop="selectCheckOutTime(t)">{{ t }}</CButton>
                </div>
              </CCol>
            </CRow>
            <CRow class="mb-3">
